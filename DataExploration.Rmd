...
print(paste("LOOCV esimate of the test error for linear regression is", predict.mse))
```
...
# I'm pretty sure that cv.tree fucntion is using LOOCV but I can't find information to support that assumption
