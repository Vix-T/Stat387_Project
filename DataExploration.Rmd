...
MSE_vector <- c(unpruned_MSE, pruned_MSE, bagged500_MSE, bagged1000_MSE, rf500_MSE, rf1000_MSE)
y_values <- seq(0, 20000, length.out = length(MSE_vector))
df <- data.frame(Method = c("unpruned", "pruned", "bagged500", "bagged1000", "rf500", "rf1000"),
                 MSE = MSE_vector)
