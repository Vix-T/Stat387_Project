...
MSE_vector <- c(unpruned_MSE, pruned_MSE, bagged500_MSE, bagged1000_MSE, rf500_MSE, rf1000_MSE, boost_MSE, h.predict.mse)
y_values <- seq(0, 20000, length.out = length(MSE_vector))
df <- data.frame(Method = c("Unpruned", "Pruned", "bagged500", "bagged1000", "RF500", "RF1000", "Boost", "Linear Model"),
                 MSE = MSE_vector)
...
error_vector <- c(sqrt(unpruned_MSE), sqrt(pruned_MSE), sqrt(bagged500_MSE), sqrt(bagged1000_MSE), sqrt(rf500_MSE), sqrt(rf1000_MSE), sqrt(boost_MSE), sqrt(h.predict.mse))
